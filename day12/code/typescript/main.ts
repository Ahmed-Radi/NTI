...
class Owner implements Iperson{
    ...
    IperrsonName(x: string): string {
        return `Hellooo from IpersonName ${x}`
    }
...
let ownerObject = new Owner('Mostafa',30)
console.log(ownerObject.IperrsonName('yassin'))
